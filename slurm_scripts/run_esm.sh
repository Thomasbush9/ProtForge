...
ARRAY_JOB_ID="$(
  sbatch --parsable \
    ...
    --export=ALL,MANIFEST="$MANIFEST",BASE_OUTPUT_DIR="$OUTPUT_DIR",ESM_CHUNKS_DIR="$ESM_CHUNKS_DIR",ESM_ENV_PREFIX="${ESM_ENV_PREFIX:-}",ESM_WORK_DIR="${ESM_WORK_DIR:-}",ESM_CACHE_DIR="${ESM_CACHE_DIR:-}" \
