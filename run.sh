...
# Runs the core pipeline: MSA + Boltz (structure prediction).
# For ESM/ES, use the standalone scripts: run_esm_standalone.sh, run_es_standalone.sh
...
export SLURM_MSA_PARTITION SLURM_BOLTZ_PARTITION
...
echo "==============================================="
echo "Orchestrating pipeline (msa=$RUN_MSA boltz=$RUN_BOLTZ)"
echo "==============================================="
...
echo "For ESM/ES, use standalone scripts: ./run_esm_standalone.sh, ./run_es_standalone.sh"
echo "To check for errors and retry: ./slurm_scripts/checker.sh msa|boltz <output_dir> [config.yaml]"
echo "==============================================="
